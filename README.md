![logo](docs/identity/logo_text.png)
...
## Usage
**NOTE:** If you compile Dievas yourself, it is highly recommended to use "Release" build, as Debug affects performance negatively.
